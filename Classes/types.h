...
TLTVERTEX TLTVertex(float x, float y, float z, float rhw, DWORD color, float tu, float tv)
{
	TLTVERTEX temp;
	temp.x = x;
	temp.y = y;
...
LVERTEX LVertex(float x, float y, float z, DWORD color)
{
	LVERTEX temp;
	temp.x = x;
	temp.y = y; 
...
TLVERTEX TLVertex(float x, float y, float z, float rhw, DWORD color)
{
	TLVERTEX temp;
	temp.x = x;
	temp.y = y;
...
TVERTEX TVertex(float x, float y, float z, float tu, float tv)
{
	TVERTEX temp;
	temp.x = x;
	temp.y = y;
...
TNVERTEX TNVertex(float x, float y, float z, float nx, float ny, float nz, float tu, float tv)
{
	TNVERTEX temp;
	temp.x = x;
	temp.y = y;
