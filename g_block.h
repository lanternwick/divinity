...
#define GSS(b, a) std::stringstream(b.attribute(std::string(a)))
#define WGSS(b, a) std::basic_stringstream<wchar_t>(b.attribute(std::basic_string<wchar_t>(a)))
#define GSSI(b, a, n) { std::stringstream ss; ss << n; b.attribute(std::string(a)) = ss.str(); }
