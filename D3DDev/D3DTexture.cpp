...
{
	Core::Function_Enter("D3DTexture::Constructor()");
	//type = OBJ_TEXTURE;
	texture = NULL;
...
{
	Core::Function_Enter("D3DTexture::Constructor(char*)");
...
D3DTexture::~D3DTexture()
{
	...
	Core::Function_Enter("D3DTexture::Destructor()");
	Release();
...
{
	Core::Function_Enter("D3DTexture::Set()");
...
VOID D3DTexture::ResetDeviceObjects()
{
	...
	Core::Function_Enter("D3DTexture::ResetDeviceObjects()");

	CreateTextureFromMemory(myDev, (char*)myData, m_width);
	Core::Function_Exit();
	return;
}
...
{
	Core::Function_Enter("D3DTexture::Release()");
	if(texture)
	{
		texture->Release();
